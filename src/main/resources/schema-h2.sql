...
CREATE SEQUENCE BATCH_STEP_EXECUTION_SEQ IF NOT EXISTS;
CREATE SEQUENCE BATCH_JOB_EXECUTION_SEQ IF NOT EXISTS;
CREATE SEQUENCE BATCH_JOB_SEQ IF NOT EXISTS;
